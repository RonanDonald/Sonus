...
class MenuBarManager: ObservableObject {
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "MenuBarManager")
    ...
    private var engine: SonusEngine?
    ...
    func configure(modelContainer: ModelContainer, engine: SonusEngine) {
