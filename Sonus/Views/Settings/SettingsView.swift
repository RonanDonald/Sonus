        ...
        Form {
            ...
            Section("Recording Feedback") {
                ...
                ExpandableSettingsRow(
                    ...
                    infoMessage: "Sonus temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard."
                ) {
            ...
            Section {
                ...
                Text("Control how Sonus handles your transcription data and audio recordings.")
            }
    ...
    var body: some View {
        Section {
            ExpandableSettingsRow(
                ...
                infoURL: "https://github.com/RonanDonald/Sonus"
            ) {
