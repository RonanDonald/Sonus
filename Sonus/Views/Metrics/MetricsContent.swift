...
struct MetricsContent: View {
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "MetricsContent")
    ...
    private var accessibilityPermissionCallout: some View {
        PermissionCard(
            ...
            description: "Sonus needs Accessibility permission to work reliably across your entire Mac",
            isGranted: isAccessibilityEnabled,
            buttonTitle: "Open System Settings",
            buttonAction: openAccessibilitySettings,
            checkPermission: refreshAccessibilityStatus,
            infoTipMessage: "Sonus uses Accessibility to work reliably across apps."
        )
    }
    ...
    private var metricsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            MetricCard(
                ...
                detail: "Sonus sessions completed",
                color: .purple
            )
            ...
            MetricCard(
                ...
                value: hasLoadedMetricsSnapshot && averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "Sonus vs. typing by hand",
                color: .yellow
            )
    ...
    private var heroSubtitle: String {
        ...
        guard totalCount > 0 else {
            return "Your Sonus journey starts with your first recording."
        }
