        ...
        Section("AI Provider Integration") {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if aiService.selectedProvider == .ollama {
                    ...
                    Text("Environment variables available: SONUS_SYSTEM_PROMPT, SONUS_USER_PROMPT, SONUS_FULL_PROMPT. Sonus also writes SONUS_FULL_PROMPT to stdin for every command.")
                        .font(.caption)
                        .foregroundColor(.secondary)
