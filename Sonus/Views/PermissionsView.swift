        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                CompactHeroSection(
                    ...
                    description: "Sonus requires the following permissions to function properly"
                )
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use Sonus anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sonus to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sonus to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "Sonus uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sonus to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "Sonus captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                        infoTipLink: "https://github.com/RonanDonald/Sonus"
                    )
                }
            }
            .padding(24)
