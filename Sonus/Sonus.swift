...
struct SonusApp: App {
    ...
    @StateObject private var engine: SonusEngine
    ...
    init() {
        ...
        let logger = Logger(subsystem: "com.ronandonald.sonus", category: "Initialization")
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "Sonus couldn't access its storage location. Your transcriptions will not be saved between sessions."
        ...
        let appSupportDirectory = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("com.ronandonald.Sonus")
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) -> ModelContainer? {
        do {
            ...
            let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
                .appendingPathComponent("com.ronandonald.Sonus", isDirectory: true)
            ...
            #else
            let dictionaryCloudKit: ModelConfiguration.CloudKitDatabase = .private("iCloud.com.ronandonald.Sonus")
            #endif
        ...
        WindowGroup {
            if hasCompletedOnboarding {
                ContentView()
                    ...
                    .onAppear {
                        ...
                        if containerInitializationFailed {
                            ...
                            alert.informativeText = "Sonus cannot initialize its storage system. The app cannot continue.\n\nPlease try reinstalling the app or contact support if the issue persists."
                ...
                OnboardingView(hasCompletedOnboarding: $hasCompletedOnboarding)
                    ...
                    .background(WindowAccessor { window in
                        if window.identifier == nil || window.identifier != NSUserInterfaceItemIdentifier("com.ronandonald.sonus.onboardingWindow") {
