...
class RecorderUIManager: ObservableObject {
    ...
    private weak var engine: SonusEngine?
    private var recorder: Recorder?

    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "RecorderUIManager")

    init() {}

    /// Call after SonusEngine is created to break the circular init dependency.
    func configure(engine: SonusEngine, recorder: Recorder) {
        self.engine = engine
