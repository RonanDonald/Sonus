...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.ronandonald.sonus.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.ronandonald.sonus.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("SonusMainWindowFrame")

    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "WindowManager")
