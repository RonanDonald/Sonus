...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.ronandonald.sonus.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.ronandonald.sonus.audioSetup", qos: .userInitiated)
