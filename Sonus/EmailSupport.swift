...
struct EmailSupport {
    private static let supportEmailAddress = "support@example.com"
    private static let supportEmailSubject = "Sonus Support Request"
    ...
    static func generateSupportEmailBody() -> String {
        ...
        ## 📋 COMMON ISSUES:
        Check out our Common Issues page before sending an email: https://github.com/RonanDonald/Sonus/issues
        ------------------------
