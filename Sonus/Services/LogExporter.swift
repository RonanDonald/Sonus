...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "LogExporter")
    private let subsystem = "com.ronandonald.sonus"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Sonus Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Sonus_Logs_\(timestamp).log"
