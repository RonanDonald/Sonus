...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: SonusEngine) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: SonusEngine) async {
