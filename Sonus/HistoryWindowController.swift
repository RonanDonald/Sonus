...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.ronandonald.sonus.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("SonusHistoryWindowFrame")

    private override init() {
        super.init()
    }

    func showHistoryWindow(modelContainer: ModelContainer, engine: SonusEngine) {
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: SonusEngine) -> NSWindow {
        ...
        window.title = "Sonus — Transcription History"
