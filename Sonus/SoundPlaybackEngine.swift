...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.ronandonald.sonus.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.ronandonald.sonus", category: "SoundPlaybackEngine")
